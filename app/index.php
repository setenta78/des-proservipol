...
if (isset($_POST["grabar"]) && $_POST["grabar"] == "si") {
    ...
    if (empty($user) || empty($pass)) {
        die("Error: Debes ingresar tu código de funcionario y contraseña.");
    }

    // Crear instancia de la clase Trabajo y llamar al método login()
    ...
    <div class="margintop-login">
        <div class="carabineros">
            <div style="line-height: 32px; width: 85%; float: right; text-align: left;">
                <h3 class="title-name-app">MESA DE AYUDA</h3>
                <h5 class="subtitle-name-app">DEPTO. CONTROL DE GESTIÓN Y SIST. DE INFORMACIÓN</h5>
            </div>
            <div style="width: 25%">
                <img src="assets/images/carabineros.png" width="58" height="auto">
            </div>
        </div>
            ...
            <div class="input-size">
                <form id="form_login" action="index.php" method="post" autocomplete="off">
                    ...
                    <div style="float: left;">
                        <!-- Enlace descomentado -->
                        <!--<a href="http://autentificatic.carabineros.cl/password/reset" style="width: 50%">Recuperar contraseña</a>-->
                    </div>
                    ...
                    <div class="text-center">
                        <p style="margin-bottom: 0px;"><strong>Sistema Mesa de Ayuda - Proservipol V3.9</strong></p>
                    </div>
                </form>
            </div>
        </div>
        <div class="text-center information-bottom">
            <div class="title-by">Desarrollado por el Depto. Control de Gestión Sistemas de Información (DCGSI) © 2025</div>
    ...
    <div id="popup" class="overlay">
        <div id="popupBody">
            ...
            <div class="popupContent">
                <p>El objetivo del sistema es brindar asistencia eficiente a los funcionarios a través de la mesa de ayuda, 
				facilitando la resolución de errores y problemas técnicos en el Sistema Proservipol. 
				Esta plataforma permite gestionar consultas, proporcionar soporte técnico especializado y garantizar la continuidad operativa, 
				asegurando que los usuarios reciban respuestas claras y soluciones oportunas ante cualquier inconveniente presentado.</p>
            </div>
        </div>
    </div>
